...
//   btn.type = "button";
//   btn.className = `btn btn-outline-secondary category-pill ${active ? "active" : ""
//     }`;
...
//   allPill.title = `All categories — ${allPill.querySelector(".category-count").textContent
//     } books`;
...
//     pill.title = `${cat} — ${pill.querySelector(".category-count").textContent
//       } books`;
